...
let arraySlice = [getMySlice[2], getMySlice[3], getMySlice[4], getMySlice[5]]
...
sortAndReverseMe.sort((a, b)=> b.localeCompare(a))
...
let ticTacToeWinner = ticTacToeArray[0][0] !== '' && ticTacToeArray[1][1] === ticTacToeArray[0][0] && ticTacToeArray[1][1] === ticTacToeArray[2][2]
