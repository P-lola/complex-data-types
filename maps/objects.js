...
let distanceFromOrigin = Math.round(Math.sqrt((solarSystem.properties.location.x ** 2) + (solarSystem.properties.location.y ** 2) + (solarSystem.properties.location.z ** 2)))
let sizeInAUs = (solarSystem.properties.size / 149597870.7).toFixed(2)
let argonOnEarthLikeMars = solarSystem.properties.planets.find(planet => planet.name === "Earth").atmosphere.argon === solarSystem.properties.planets.find(planet => planet.name === "Mars").atmosphere.argon
